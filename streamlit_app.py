...
if st.session_state["mode"] == "questions":
    ...
    with question_form:
        ...
        st.radio("Do / Did you take nootropics to help with anxiety?", options=options, key="question_anxiety")
        retrieve_widget_value("question_focus")
        st.radio("Do / Did you take nootropics to help with focus?", options=options, key="question_focus")
        retrieve_widget_value("question_mood")
        st.radio("Do / Did you take nootropics to help with mood?", options=options, key="question_mood")
        retrieve_widget_value("question_cognition")
        st.radio("Do / Did you take nootropics to help with cognition / memory?", options=options, key="question_cognition")
        retrieve_widget_value("question_motivation")
        st.radio("Do / Did you take nootropics to help with motivation?", options=options, key="question_motivation")
        retrieve_widget_value("question_libido")
        st.radio("Do / Did you take nootropics to help with libido or other sex-related reasons?", options=options, key="question_libido")
        retrieve_widget_value("question_other")
        st.text_input("Another reason you take / took nootropics?", key="question_other")
        st.write("")
        st.write("")
